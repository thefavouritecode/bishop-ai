...
# ── CORRECTED CSS (FIXED ALIGNMENT & LAYOUT) ──────────────────────────────────
st.markdown("""
<style>
...
/* Sidebar Elements (Inputs, Expanders, Buttons) */
            ...
            for pdf in pdfs:
                ...
                with st.expander(f"📄  {label}"):
                    ...
                    with open(f"media/{pdf}", "rb") as fh:
                        st.download_button("⬇  Download PDF", fh, file_name=pdf, mime="application/pdf", use_container_width=True)
            ...
            for audio in audios:
                ...
                with st.expander(f"🎙  {label}"):
                    ...
                    with open(f"media/{audio}", "rb") as fh:
                        st.download_button("⬇  Download Audio", fh, file_name=audio, mime="audio/mpeg", use_container_width=True)
    else:
